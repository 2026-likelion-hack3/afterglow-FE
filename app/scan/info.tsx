    ...
    return (
        <>
            ...
            <View style={ Styles.container }>
                ...
                <View style={{ gap: 6, borderStyle: 'solid', borderWidth: 1, borderColor: Colors.border.default, borderRadius: 16, backgroundColor: Colors.background.subtle, padding: 20 }}>
