    ...
    return (
        <>
            ...
            <View style={ Styles.container }>
                ...
                {/* 개발 필요 */}
                <View style={{height: 230, borderStyle: 'dashed', borderWidth: 1, borderColor: Colors.sand[400], borderRadius: 20, backgroundColor: Colors.background.subtle}}>
                    <Text>카메라화면미개발</Text>
                </View>
                <View style={{ gap: 8, borderStyle: 'solid', borderWidth: 1, borderColor: Colors.border.defaultLight, borderRadius: 16, backgroundColor: Colors.background.card, padding: 20 }}>
